    ...
    <div className="p-4 md:p-8 max-w-2xl mx-auto w-full pb-24 md:pb-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2 text-lg">Lock in the time.</p>
        </div>
        {!isEditing && (
      ...
      >
        <Card className="bg-card/50 backdrop-blur-xl border-card-border shadow-2xl relative overflow-hidden">
